      ...
      <section className="h-screen w-full" id="home">
        ...
        <div>
          <div
            className="mb-8"
            data-aos="fade-right"
            style={{ padding: "200px 100px" }}
          >
            <div className="grid grid-cols-2 gap-8 items-center justify-center">
              <div className="flex flex-col items-start gap-4">
                <div className="flex items-center gap-4">
                  <h1 className="text-4xl font-bold text-white">Hi, I'm</h1>
                  <TrueFocus
              ...
              <div className="flex items-center justify-center gap-4">
                <Image
                  src={purli}
                  alt="Globe"
                  className="rounded-full w-auto h-100"
                />
              </div>
            </div>
          </div>
      ...
      <section className="h-screen w-full" id="about">
        ...
        <div className="flex items-center h-full">
          <div className="grid grid-cols-2 gap-8 items-center justify-center">
            ...
            <div className="max-w-2xl text-left mx-10">
              ...
              <p className="text-lg text-gray-300">
                ...
                am always eager to learn and adapt to new technologies, and I
                thrive in collaborative environments where I can work with
                others to solve complex problems. Let's connect and create
        ...
        <div className="flex items-center justify-center h-full">
          <div className="max-w-4xl text-center">
            ...
            <div className="flex justify-center items-center gap-10 mt-8">
              <span>
                <a href="https://github.com/BerlianPurliN" target="_blank">
                  <svg
              ...
              <span>
                <a href="https://wa.me/6285730560388" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="50"
                    height="50"
