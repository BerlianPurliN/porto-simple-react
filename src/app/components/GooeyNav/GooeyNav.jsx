...
const GooeyNav = ({
  ...
  // Tambahkan props baru untuk kontrol external
  ...
  // Update activeIndex ketika externalActiveIndex berubah
  useEffect(() => {
    if (externalActiveIndex !== null && externalActiveIndex !== activeIndex) {
      ...
      if (navRef.current) {
        ...
        if (activeLi) {
          ...
          handleClick(fakeEvent, externalActiveIndex, true); // true = skip external callback
        }
      }
    }
  }, [externalActiveIndex]);
  ...
  // Modifikasi handleClick untuk mendukung external control
  const handleClick = (e, index, skipExternalCallback = false) => {
    ...
    // Panggil callback external jika ada dan tidak di-skip
    if (onActiveChange && !skipExternalCallback) {
  ...
  // Modifikasi handleAnchorClick untuk mendukung custom onClick
  const handleAnchorClick = (e, item, index) => {
    // Jika item memiliki custom onClick handler, gunakan itu
    if (item.onClick) {
      item.onClick(e);
    }
